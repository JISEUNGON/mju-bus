...
public interface BusCalendarRepository extends JpaRepository<BusCalendar, String> {
    ...
    Optional<BusCalendar> findBusCalendarByDateOnWeekday(@Param("date") LocalDate date, @Param("time") LocalTime time);
    ...
    Optional<BusCalendar> findBusCalendarByDateOnWeekend(@Param("date") LocalDate date, @Param("time") LocalTime time);
