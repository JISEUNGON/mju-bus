...
public class PathServiceImpl implements PathService {
    ...
    private final PathDetailRepository pathDetailRepository;
    private final PathInfoRepository pathInfoRepository;

    private static int offset = 1;

    @Autowired
    public PathServiceImpl (RouteService routeService, PathDetailRepository pathDetailRepository, PathInfoRepository pathInfoRepository) {
        this.routeService = routeService;
        this.pathDetailRepository = pathDetailRepository;
