...
echo "\033[32m"
echo "======================================================================="
echo "‖            [MASTER]             1. Clean BUS Server                 ‖"
echo "======================================================================="
echo "\033[0m"
cd bus-server/
./gradlew clean
...
echo "\033[32m"
echo "======================================================================="
echo "‖            [MASTER]             2. Build BUS Server                 ‖"
echo "======================================================================="
echo "\033[0m"
cd bus-server/
./gradlew build
...
echo "\033[32m"
echo "======================================================================="
echo "‖            [MASTER]             3. Deploy to BUS Server             ‖"
echo "======================================================================="
echo "\033[0m"
cd bus-server/build/libs/
scp -P 8022 *-SNAPSHOT.jar ubuntu@staging-api.mju-bus.com:~/bus-server/