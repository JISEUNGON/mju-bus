...
public class BusArrivalServiceImpl implements BusArrivalService {
    ...
    @Autowired
    public BusArrivalServiceImpl(StationService stationService, BusService busService, RouteService routeService, BusArrivalRepository busArrivalRepository) {
        this.stationService = stationService;
        this.busService = busService;
        this.routeService = routeService;
        this.busArrivalRepository = busArrivalRepository;
    }
    ...
    @Override
    public BusArrivalResponse findBusArrivalRemain(StationRequest req, StationRemainRequest remainReq) {
        Station srcStation, destStation;
        Boolean redBus, toSchool;
     ...
     * @return 노선 리스트
     */
    public List<BusArrivalDto> getBusArrivalListBetween(Station srcStation, Station destStation) {
     ...
     */
    public LocalTime getExpectedTimeFrom(Bus bus, Station currentStation, LocalDateTime depart_at) {
        try {
...
//                depart_at = depart_at.plusSeconds(duration);
     ...
     */
    public LocalTime getExpectedTimeTo(Bus bus, Station targetStation, LocalDateTime depart_at) {
        try {
            // 노선에 포함되어 있는 정류장 리스트
            List<StationDTO> stationDTOList = routeService.findStationsByBus(bus);
    ...
    public List<BusArrivalDto> findBusArrivalByStation(Station station) {
